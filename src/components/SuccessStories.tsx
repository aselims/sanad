            ...
            <div className="space-y-12">
              <div className="border-b border-gray-200 pb-10">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  in major urban areas. The project, which began as a challenge posted on SANAD, 
                  is now being implemented in five cities nationwide.
                </p>
                
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="italic text-gray-700">
                    "SANAD helped us find the perfect partners for our smart city initiative. 
                    ...
                    procurement processes took just weeks with SANAD."
                  </p>
              ...
              <div className="border-b border-gray-200 pb-10">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  through SANAD, led to a breakthrough diagnostic tool that is now in clinical trials 
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="italic text-gray-700">
                    ...
                    institutions. SANAD changed that by giving us visibility and credibility. 
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  on SANAD, has reduced water usage by 40% while increasing crop yields by 15%.
                </p>
                
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="italic text-gray-700">
                    "SANAD brought together partners we would never have found on our own. 
