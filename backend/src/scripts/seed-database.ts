...
const challengeSeedData = [
  {
    ...
    description:
      'Develop innovative solutions for green hydrogen production, storage, and distribution to establish NEOM as a global hydrogen hub.',
    organization: 'NEOM',
    ...
    eligibilityCriteria:
      'Open to technology companies, research institutions, and startups with hydrogen technology expertise.',
  },
  {
    title: 'Saudi Vision 2030 Digital Transformation Accelerator',
    description:
      'Create AI-powered solutions to accelerate digital transformation in government services, healthcare, and education sectors.',
    organization: 'Vision 2030 Realization Office',
  ...
  },
  {
    ...
    description:
      "Develop technologies and business models that convert waste into valuable resources, supporting Saudi Arabia's circular economy goals.",
    organization: 'Green Saudi Initiative',
    type: ChallengeType.GOVERNMENT,
    status: ChallengeStatus.OPEN,
    deadline: '2024-11-15',
    ...
    eligibilityCriteria:
      'Open to cleantech startups, waste management companies, and environmental technology providers.',
  },
  {
    title: 'Space Technology Applications Challenge',
    description:
      'Leverage satellite technology and space applications for Earth observation, telecommunications, and navigation in Saudi Arabia.',
    organization: 'Saudi Space Commission',
    type: ChallengeType.GOVERNMENT,
    ...
    eligibilityCriteria:
      'Open to space technology companies, satellite manufacturers, and aerospace research institutions.',
  },
  {
    title: 'Entertainment Tech Innovation Challenge',
    description:
      "Create immersive entertainment experiences using AR/VR, AI, and interactive technologies for Saudi Arabia's growing entertainment sector.",
    ...
    eligibilityCriteria:
      'Open to entertainment technology companies, gaming studios, and immersive experience developers.',
  },
  {
    title: 'Red Sea Tourism Innovation Hub',
    description:
      'Develop sustainable tourism technologies and experiences for the Red Sea Project, focusing on marine conservation and luxury eco-tourism.',
    ...
    eligibilityCriteria:
      'Open to tourism technology companies, marine conservation organizations, and sustainable hospitality providers.',
  },
  {
    title: 'Healthcare AI Diagnostics for Rural Areas',
    description:
      'Develop AI-powered diagnostic tools specifically designed for remote healthcare delivery in rural Saudi communities.',
    ...
    eligibilityCriteria:
      'Open to healthtech startups, medical AI companies, and telemedicine providers.',
  },
  {
    title: 'Smart Agriculture for Desert Environments',
    description:
      'Create innovative agricultural technologies that maximize crop yields while minimizing water usage in arid Saudi environments.',
    ...
    eligibilityCriteria:
      'Open to agtech companies, biotechnology firms, and agricultural research institutions.',
  },
  {
    title: 'Women Entrepreneurship Support Platform',
    description:
      'Build digital platforms and tools that empower women entrepreneurs in Saudi Arabia with mentorship, funding, and market access.',
    ...
    eligibilityCriteria:
      'Open to fintech companies, platform developers, and women-focused business solution providers.',
  },
  {
    title: 'Carbon Capture and Utilization Technologies',
    description:
      "Develop innovative carbon capture, utilization, and storage (CCUS) technologies to support Saudi Arabia's net-zero emissions goal by 2060.",
    organization: 'Saudi Aramco',
    type: ChallengeType.CORPORATE,
    status: ChallengeStatus.OPEN,
    deadline: '2025-06-30',
    ...
    eligibilityCriteria:
      'Open to cleantech companies, energy technology providers, and carbon management specialists.',
  },
];
...
const partnershipSeedData = [
  {
    ...
    description:
      "Strategic partnership to develop next-generation materials for sustainable construction and manufacturing in NEOM's futuristic city development.",
    participants: ['NEOM', 'KAUST', 'SABIC'],
    status: PartnershipStatus.ACTIVE,
    duration: '5 years',
    resources:
      'SAR 50,000,000 joint funding, world-class research facilities, and commercial testing sites',
    expectedOutcomes:
      'Revolutionary sustainable building materials, reduced construction costs, and establishment of Saudi Arabia as a global materials innovation hub.',
  },
  {
    title: 'Vision 2030 Digital Government Transformation Alliance',
    description:
      'Comprehensive partnership to digitize all government services and establish Saudi Arabia as a leader in digital governance.',
    participants: ['Vision 2030 Office', 'Saudi Data and AI Authority', 'MCIT', 'Elm Company'],
    status: PartnershipStatus.ACTIVE,
    duration: '7 years',
    resources:
      'SAR 100,000,000 investment, national digital infrastructure, and AI development platforms',
    expectedOutcomes:
      '100% digital government services, improved citizen experience, and global recognition as digital government leader.',
  },
  {
    title: 'Green Saudi Climate Technology Partnership',
    description:
      "Multi-sector partnership focused on developing and deploying climate technologies to achieve Saudi Arabia's net-zero emissions by 2060.",
    participants: ['Green Saudi Initiative', 'Saudi Aramco', 'ACWA Power', 'KFUPM'],
    status: PartnershipStatus.ACTIVE,
    duration: '15 years',
    resources:
      'SAR 200,000,000 climate fund, renewable energy infrastructure, and international technology partnerships',
    expectedOutcomes:
      '50% reduction in carbon emissions, establishment of major carbon capture facilities, and leadership in clean energy export.',
  },
  {
    title: 'Red Sea Marine Conservation Innovation Hub',
    description:
      'Pioneering partnership combining luxury tourism with marine conservation using advanced monitoring and protection technologies.',
    participants: [
      'Red Sea Global',
    ...
    duration: '10 years',
    resources:
      'SAR 75,000,000 conservation fund, marine research vessels, and AI monitoring systems',
    expectedOutcomes:
      "World's first regenerative tourism destination, 300% increase in marine biodiversity, and global marine conservation leadership.",
  },
  {
    title: 'Saudi Space Economy Development Consortium',
    description:
      'Strategic alliance to establish Saudi Arabia as a regional space technology leader through satellite manufacturing and space services.',
    participants: ['Saudi Space Commission', 'KACST', 'STDIC', 'Thales Alenia Space'],
    status: PartnershipStatus.ACTIVE,
    duration: '8 years',
    resources:
      'SAR 150,000,000 space development fund, satellite manufacturing facilities, and international space partnerships',
    expectedOutcomes:
      'Launch of 20+ national satellites, establishment of regional satellite services, and creation of 5,000 high-tech jobs.',
  },
  {
    title: 'Entertainment and Media Technology Innovation Alliance',
    description:
      'Collaborative initiative to position Saudi Arabia as a global entertainment technology hub supporting the growing entertainment sector.',
    participants: [
    ...
    duration: '4 years',
    resources:
      'SAR 30,000,000 creative technology fund, production facilities, and international distribution networks',
    expectedOutcomes:
      'Production of 100+ local content pieces, establishment of entertainment technology cluster, and attraction of major international studios.',
  },
  {
    title: 'Women Entrepreneurship Ecosystem Partnership',
    description:
      'Comprehensive support system for women entrepreneurs covering funding, mentorship, market access, and international expansion.',
    participants: [
      'Monshaat',
      'Saudi Women Development Society',
      'Khadijah Center',
      'Endeavor Saudi',
    ],
    status: PartnershipStatus.ACTIVE,
    duration: '6 years',
    resources:
      'SAR 25,000,000 women entrepreneur fund, mentorship networks, and international market access programs',
    expectedOutcomes:
      'Support for 1,000+ women-led startups, creation of 10,000 jobs for women, and establishment of regional women entrepreneurship hub.',
  },
  {
    title: 'Circular Economy Industrial Transformation Partnership',
    description:
      'Large-scale industrial partnership to transform traditional manufacturing into circular economy models across multiple sectors.',
    participants: [
      'Saudi Industrial Dev Fund',
      'SABIC',
      'Maaden',
      'Saudi Recycling Co',
    ...
    duration: '10 years',
    resources:
      'SAR 500,000,000 transformation fund, industrial infrastructure, and circular economy expertise',
    expectedOutcomes:
      '80% waste reduction in participating industries, creation of new circular economy business models, and establishment as regional circular economy leader.',
  },
];
...
const ideasData = [
  {
    ...
    description:
      'A smart IoT-based water management system that monitors and optimizes water usage in agricultural settings, reducing waste by up to 40% while maintaining crop yields.',
    category: 'Agriculture',
    stage: IdeaStage.PROTOTYPE,
    targetAudience: 'Farmers and agricultural businesses in arid regions',
    potentialImpact:
      'Significant reduction in water consumption for agriculture, enabling sustainable farming in water-scarce regions',
    resourcesNeeded:
      'IoT hardware expertise, agricultural partnerships for field testing, and funding for prototype deployment',
    creatorEmail: 'ahmed@techstartup.sa',
  },
  {
    title: 'AI-Powered Medical Diagnosis Assistant',
    description:
      'An artificial intelligence system that helps doctors diagnose rare diseases by analyzing patient symptoms, medical history, and comparing with global medical databases.',
    category: 'Healthcare',
    stage: IdeaStage.VALIDATED,
    targetAudience: 'Healthcare providers, hospitals, and medical clinics',
    potentialImpact:
      'Faster and more accurate diagnosis of rare conditions, reducing misdiagnosis rates and improving patient outcomes',
    resourcesNeeded:
      'Medical data partnerships, AI development expertise, and regulatory compliance support',
    creatorEmail: 'fatima@aihealth.sa',
  },
  {
    title: 'Solar-Powered Desalination Units',
    description:
      'Compact, modular desalination units powered entirely by solar energy, designed for deployment in coastal communities with limited access to fresh water.',
    category: 'Environment',
    stage: IdeaStage.CONCEPT,
    targetAudience: 'Coastal communities facing water scarcity',
    potentialImpact:
      'Sustainable access to clean drinking water without reliance on fossil fuels or extensive infrastructure',
    resourcesNeeded:
      'Engineering expertise in desalination technology, solar power integration, and funding for initial prototypes',
    creatorEmail: 'mohammed@kaust.edu.sa',
  },
  {
    title: 'Blockchain-Based Supply Chain Verification',
    description:
      'A blockchain platform that enables end-to-end verification of product origins and handling, ensuring authenticity and ethical sourcing for consumers.',
    category: 'Technology',
    stage: IdeaStage.PROTOTYPE,
    targetAudience: 'Retail businesses, manufacturers, and conscious consumers',
    potentialImpact:
      'Increased transparency in global supply chains, reduction in counterfeit products, and support for ethical business practices',
    resourcesNeeded:
      'Blockchain developers, industry partnerships for pilot implementation, and UX design expertise',
    creatorEmail: 'layla@ksu.edu.sa',
  },
  {
    title: 'Microplastic Filtering System for Washing Machines',
    description:
      'An affordable filter attachment for washing machines that captures microplastics from synthetic clothing before they enter the water system.',
    category: 'Environment',
  ...
  },
  {
    ...
    description:
      'A VR platform that allows students to explore historical sites and cultural artifacts in an immersive, interactive environment, preserving cultural heritage while making it accessible globally.',
    category: 'Education',
    stage: IdeaStage.CONCEPT,
    targetAudience: 'Educational institutions, museums, and cultural organizations',
    potentialImpact:
      'Enhanced preservation and global access to cultural heritage, improved educational outcomes through immersive learning',
    resourcesNeeded:
      '3D modeling expertise, cultural heritage partnerships, and VR development resources',
    creatorEmail: 'fatima@aihealth.sa',
  },
  {
    title: 'Biodegradable Packaging from Agricultural Waste',
    description:
      'A process to convert agricultural waste into fully biodegradable packaging materials, reducing both waste and plastic pollution.',
    category: 'Sustainability',
    stage: IdeaStage.VALIDATED,
    targetAudience: 'Food producers, retailers, and packaging manufacturers',
    potentialImpact:
      'Reduction in plastic waste and repurposing of agricultural byproducts into valuable materials',
    resourcesNeeded:
      'Materials science expertise, manufacturing facilities, and certification support',
    creatorEmail: 'mohammed@kaust.edu.sa',
  },
  {
    title: 'Peer-to-Peer Energy Trading Platform',
    description:
      'A platform enabling households with solar panels to sell excess energy directly to neighbors, creating a localized renewable energy marketplace.',
    category: 'Energy',
    stage: IdeaStage.PROTOTYPE,
    targetAudience: 'Homeowners with renewable energy installations and energy consumers',
    potentialImpact:
      'Accelerated adoption of renewable energy and more efficient use of locally generated power',
    resourcesNeeded:
      'Software development, regulatory navigation expertise, and pilot community partnerships',
    creatorEmail: 'layla@ksu.edu.sa',
  },
  {
    title: 'Desert-to-Cloud Data Centers',
    description:
      'Sustainable data centers in Saudi desert regions using solar power and innovative cooling systems, providing cloud services while minimizing environmental impact.',
    category: 'Technology',
    stage: IdeaStage.CONCEPT,
    targetAudience:
      'Cloud service providers, government agencies, and tech companies requiring data storage',
    potentialImpact:
      'Reduced carbon footprint of digital infrastructure while establishing Saudi Arabia as a regional digital hub',
    resourcesNeeded:
      'Data center engineering expertise, renewable energy systems, and government partnerships',
    creatorEmail: 'sarah@neom.sa',
  },
  {
    title: 'Hajj and Umrah Smart Experience Platform',
    description:
      'AI-powered platform providing personalized guidance, crowd management, and spiritual journey enhancement for pilgrims visiting Mecca and Medina.',
    category: 'Tourism',
    stage: IdeaStage.VALIDATED,
    targetAudience: 'Muslim pilgrims worldwide and Saudi religious tourism authorities',
    potentialImpact:
      'Enhanced spiritual experience for millions of pilgrims while improving safety and operational efficiency',
    resourcesNeeded:
      'AI development, religious consultation, crowd management expertise, and government collaboration',
    creatorEmail: 'faisal@entertainment.sa',
  },
  {
    title: 'Marine Plastic-to-Fuel Conversion Ships',
    description:
      'Mobile platforms that collect ocean plastic waste and convert it into clean fuel using advanced pyrolysis technology, cleaning seas while producing energy.',
    category: 'Environment',
    stage: IdeaStage.CONCEPT,
    targetAudience: 'Marine conservation organizations, fuel companies, and coastal nations',
    potentialImpact:
      'Significant reduction in ocean plastic pollution while creating sustainable fuel source',
    resourcesNeeded:
      'Marine engineering, pyrolysis technology expertise, and international maritime partnerships',
    creatorEmail: 'nora@greeninitiative.sa',
  },
  {
    title: 'Camel-Inspired Desert Agriculture Robots',
    description:
      'Biomimetic robots designed like camels that can navigate desert terrain to plant seeds, deliver water, and monitor crop health in extreme arid conditions.',
    category: 'Agriculture',
    stage: IdeaStage.PROTOTYPE,
    targetAudience: 'Desert agriculture companies and food security initiatives',
    potentialImpact:
      'Expansion of agricultural production in previously unusable desert areas, enhancing food security',
    resourcesNeeded:
      'Robotics engineering, biomimicry research, and agricultural technology integration',
    creatorEmail: 'khalid@space.sa',
  },
  {
    title: 'Cultural Heritage NFT Marketplace',
    description:
      'Blockchain-based platform for creating, trading, and experiencing digital representations of Saudi cultural artifacts and historical sites as NFTs.',
    category: 'Technology',
    stage: IdeaStage.SCALING,
    targetAudience: 'Cultural institutions, collectors, tourists, and digital art enthusiasts',
    potentialImpact:
      'Preservation and global sharing of Saudi cultural heritage while creating new revenue streams',
    resourcesNeeded:
      'Blockchain development, cultural expertise, digital art creation, and international marketing',
    creatorEmail: 'fatima@aihealth.sa',
  },
  {
    title: 'Arabic Language AI Medical Assistant',
    description:
      'Advanced AI system specifically trained in Arabic medical terminology and Saudi healthcare protocols to assist doctors and patients with diagnosis and treatment recommendations.',
    category: 'Healthcare',
    stage: IdeaStage.VALIDATED,
    targetAudience: 'Healthcare providers in Arabic-speaking regions and medical students',
    potentialImpact:
      'Improved healthcare access and quality in Arabic-speaking communities globally',
    resourcesNeeded:
      'Medical AI expertise, Arabic language processing, and healthcare data partnerships',
    creatorEmail: 'amira@healthtech.sa',
  },
  {
    title: 'Modular Floating Solar Farms for Red Sea',
    description:
      'Innovative floating solar panel systems designed for marine environments, providing clean energy while minimizing impact on marine ecosystems.',
    category: 'Energy',
    stage: IdeaStage.CONCEPT,
    ...
    resourcesNeeded:
      'Marine engineering, solar technology, and environmental impact assessment expertise',
    creatorEmail: 'mohammed@kaust.edu.sa',
  },
  {
    title: 'Space Debris to Satellite Manufacturing',
    description:
      'Technology to capture and recycle space debris into raw materials for manufacturing new satellites, addressing the space junk problem while reducing launch costs.',
    category: 'Space Technology',
    stage: IdeaStage.CONCEPT,
    targetAudience:
      'Space agencies, satellite manufacturers, and space debris management organizations',
    potentialImpact:
      "Cleaning Earth's orbital environment while creating sustainable satellite manufacturing",
    resourcesNeeded:
      'Space technology expertise, orbital mechanics, and international space cooperation',
    creatorEmail: 'khalid@space.sa',
  },
  {
    title: 'Virtual Reality Therapy for PTSD',
    description:
      'Culturally-sensitive VR therapy platform designed specifically for Arabic-speaking patients dealing with PTSD and anxiety disorders.',
    category: 'Healthcare',
    stage: IdeaStage.VALIDATED,
    targetAudience: 'Mental health professionals, hospitals, and patients in the MENA region',
    potentialImpact:
      'Improved mental health treatment outcomes while addressing cultural barriers to therapy',
...
const collaborationSeedData = [
  {
    ...
    description:
      'Developing AI-powered smart city infrastructure for NEOM, including traffic management, energy optimization, and citizen services integration.',
  ...
  },
  {
    ...
    description:
      'A collaborative research initiative to develop sustainable agriculture solutions for arid environments using advanced biotechnology and water management systems.',
  ...
  },
  {
    ...
    description:
      'A comprehensive accelerator program for fintech startups focusing on Islamic finance, digital payments, and financial inclusion in Saudi Arabia.',
  ...
  },
  {
    ...
    description:
      'Empowering women entrepreneurs and technologists in Saudi Arabia through mentorship, funding opportunities, and leadership development programs.',
  ...
  },
  {
    ...
    description:
      "Developing cost-effective green hydrogen production methods using solar energy for Saudi Arabia's clean energy transition.",
    type: CollaborationType.RESEARCH,
    status: CollaborationStatus.ACTIVE,
  ...
  },
  {
    ...
    description:
      'Commercializing AI-powered diagnostic tools for early detection of chronic diseases in Saudi healthcare system.',
  ...
  },
  {
    ...
    description:
      "Establishing a circular economy manufacturing hub that converts waste materials into valuable products, supporting Saudi Arabia's sustainability goals.",
    type: CollaborationType.PROJECT,
  ...
  },
  {
    ...
    description:
      'Using advanced digital technologies to preserve and showcase Saudi cultural heritage through immersive experiences and virtual museums.',
    type: CollaborationType.PROJECT,
    status: CollaborationStatus.ACTIVE,
...
const matchSeedData = [
  {
    ...
    highlight:
      'Both focused on sustainable technology solutions with complementary expertise in practical implementation and research',
  },
  {
    ...
    highlight:
      'AI healthcare innovation expertise meets venture capital funding for medical technology commercialization',
  },
  {
    ...
    highlight:
      'Corporate digital transformation experience aligns with government digitalization initiatives',
  },
  {
    ...
    highlight:
      'Biotechnology research expertise perfectly complements sustainable agriculture technology development',
  },
  {
    ...
    highlight:
      'Startup acceleration programs align with experienced entrepreneur in fintech sector',
  },
  {
    ...
    highlight:
      'Government research administration expertise complements university research capabilities',
  },
];
...
const messageSeedData = [
  {
    ...
    receiverEmail: 'mohammed@kaust.edu.sa',
    content:
      'Hi Dr. Al-Qahtani, I saw your work on solar technology applications in desert environments. Our startup is working on sustainable urban solutions and I believe there could be great synergy between our projects. Would you be interested in discussing a potential collaboration?',
    isRead: true,
  },
  {
    ...
    receiverEmail: 'ahmed@techstartup.sa',
    content:
      'Hello Ahmed, thank you for reaching out! Your work on sustainable technology solutions is very impressive. I would definitely be interested in exploring collaboration opportunities. Our desert agriculture research could benefit from your practical implementation expertise. Shall we schedule a meeting?',
    isRead: true,
  },
  {
    ...
    receiverEmail: 'saad@svc.sa',
    content:
      'Dear Mr. Al-Faisal, we have made significant progress on our AI diagnostic platform and are now ready to discuss Series A funding. Our pilot results show 94% accuracy in early chronic disease detection. I would love to present our progress and discuss investment opportunities.',
    isRead: false,
  },
  {
    ...
    receiverEmail: 'youssef@gmail.com',
    content:
      'Youssef, your experience in e-commerce and fintech makes you an ideal mentor for our upcoming accelerator cohort. We have several startups that could benefit from your expertise. Would you be interested in joining our mentor network?',
    isRead: true,
  },
];
...
const notificationSeedData = [
  ...
  },
  {
    ...
    content:
      'You have a new message from Ahmed Al-Farsi regarding sustainable technology collaboration',
    isRead: true,
  },
  {
    userEmail: 'fatima@aihealth.sa',
...
const seedPartnerships = async (adminUser: User): Promise<void> => {
  try {
    ...
    for (const partnershipData of partnershipSeedData) {
      ...
      const participants = Array.isArray(partnershipData.participants)
        ? partnershipData.participants
        : [];
...
const seedIdeas = async (): Promise<void> => {
  try {
    ...
    for (const ideaData of ideasData) {
      ...
      if (!creator) {
        logger.warn(
          `Creator with email ${ideaData.creatorEmail} not found. Skipping idea: ${ideaData.title}`
        );
        continue;
      }
...
const seedCollaborations = async (): Promise<void> => {
  try {
    ...
    if (existingCollaborationsCount > 0) {
      logger.info(
        `${existingCollaborationsCount} collaborations already exist in the database. Skipping seed.`
      );
      return;
    }
    ...
    for (const collabData of collaborationSeedData) {
      ...
      if (!owner) {
        logger.warn(
          `Owner with email ${collabData.ownerEmail} not found. Skipping collaboration: ${collabData.title}`
        );
        continue;
      }
...
const seedMatches = async (): Promise<void> => {
  try {
    ...
    for (const matchData of matchSeedData) {
      ...
      if (!user || !targetUser) {
        logger.warn(
          `User not found for match. Skipping match between ${matchData.userEmail} and ${matchData.targetUserEmail}`
        );
        continue;
      }
      ...
      logger.info(
        `Created match: ${user.firstName} ${user.lastName} <-> ${targetUser.firstName} ${targetUser.lastName}`
      );
    }
...
const seedConnections = async (): Promise<void> => {
  try {
    ...
    if (existingConnectionsCount > 0) {
      logger.info(
        `${existingConnectionsCount} connections already exist in the database. Skipping seed.`
      );
      return;
    }
    ...
    for (const connectionData of connectionSeedData) {
      ...
      if (!requester || !receiver) {
        logger.warn(
          `User not found for connection. Skipping connection between ${connectionData.requesterEmail} and ${connectionData.receiverEmail}`
        );
        continue;
      }
      ...
      logger.info(
        `Created connection: ${requester.firstName} ${requester.lastName} -> ${receiver.firstName} ${receiver.lastName} (${connectionData.status})`
      );
    }
...
const seedMessages = async (): Promise<void> => {
  try {
    ...
    if (existingMessagesCount > 0) {
      logger.info(
        `${existingMessagesCount} messages already exist in the database. Skipping seed.`
      );
      return;
    }
    ...
    for (const messageData of messageSeedData) {
      ...
      if (!sender || !receiver) {
        logger.warn(
          `User not found for message. Skipping message from ${messageData.senderEmail} to ${messageData.receiverEmail}`
        );
        continue;
      }
      ...
      logger.info(
        `Created message: ${sender.firstName} ${sender.lastName} -> ${receiver.firstName} ${receiver.lastName}`
      );
    }
...
const seedNotifications = async (): Promise<void> => {
  try {
    ...
    if (existingNotificationsCount > 0) {
      logger.info(
        `${existingNotificationsCount} notifications already exist in the database. Skipping seed.`
      );
      return;
    }
    ...
    for (const notificationData of notificationSeedData) {
      ...
      if (!user) {
        logger.warn(
          `User not found for notification. Skipping notification for ${notificationData.userEmail}`
        );
        continue;
      }
      ...
      logger.info(
        `Created notification: ${notificationData.type} for ${user.firstName} ${user.lastName}`
      );
    }
...
const seedDatabase = async () => {
  try {
    ...
    if (!adminUser) {
      logger.error(
        'Failed to create or find admin user. Cannot proceed with seeding other entities.'
      );
      process.exit(1);
    }
